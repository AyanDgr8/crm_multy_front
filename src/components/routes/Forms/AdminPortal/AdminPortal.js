        ...
        <div className="admin-portal-container">
            ...
            <div className="sectionn">
                ...
                <div className="user-formm">
                    ...
                    <button onClick={handleCreateUser} className="create-buttonn">Create User</button>
                </div>
            ...
            <div className="section">
                <h3 className='create-user-heading'>Existing Users</h3>
                    ...
                    {users.filter(user => !user.team_id && user.role !== 'super_admin').length > 0 && (
                        <div className="team-section">
                            <div className="user-row header">
                                ...
                                <div className="user-col">Email</div>
                                <div className="user-col">Role</div>
                                <div className="user-col">Team</div>
                            </div>
                            {users.filter(user => !user.team_id && user.role !== 'super_admin').map(user => (
                                <div key={user.id} className="user-row">
                                    ...
                                    <div className="user-col">{user.email}</div>
                                    <div className="user-col">{user.role}</div>
                                    <div className="user-col">{user.team_name || 'No team'}</div>
                                </div>
                            ))}
                        </div>
                    )}
